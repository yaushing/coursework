...
```
4. Run the following command to start a python shell:
```zsh
python3
```
...
6. Add password.py into the root directory of the project\
7. Run game.py from the root directory of the project with 
```zsh
python3 game.py
```
